...
func TestConcurrent1(t *testing.T) {
	...
	cfg.ShutdownGroup(0)
	fmt.Printf("ShutdownGroup 0\n")
	time.Sleep(100 * time.Millisecond)
	cfg.ShutdownGroup(1)
	fmt.Printf("ShutdownGroup 1\n")
	time.Sleep(100 * time.Millisecond)
	cfg.ShutdownGroup(2)
	fmt.Printf("ShutdownGroup 2\n")

	cfg.leave(2)
	fmt.Printf("leave 2\n")
	time.Sleep(100 * time.Millisecond)
	cfg.StartGroup(0)
	fmt.Printf("StartGroup 0\n")
	cfg.StartGroup(1)
	fmt.Printf("StartGroup 1\n")
	cfg.StartGroup(2)
	fmt.Printf("StartGroup 2\n")
